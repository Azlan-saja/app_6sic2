import 'package:app_6sic2/pages/catatan.dart';
import 'package:app_6sic2/pages/home.dart';
import 'package:app_6sic2/pages/informasi.dart';
import 'package:app_6sic2/pages/luas.dart';
import 'package:app_6sic2/pages/volume.dart';
        ...
        title: Row(
          children: [
            ...
            Column(
              ...
              children: const [
                MyTextSedang(data: 'Welcome', color: Color(0xFFFFFFFF)),
                MyTextKecil(
                    data: 'Azlan, S.Kom., M.Kom', color: Color(0xFFFFFFFF)),
              ],
            ),
          ],
        ),
